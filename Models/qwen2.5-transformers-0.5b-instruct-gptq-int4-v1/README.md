---
license: apache-2.0
license_link: https://huggingface.co/Qwen/Qwen2.5-0.5B-Instruct-GPTQ-Int4/blob/main/LICENSE
language:
- en
...
**This repo contains the GPTQ-quantized 4-bit instruction-tuned 0.5B Qwen2.5 model**, which has the following features:
